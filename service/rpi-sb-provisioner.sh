...
sleep 2
fastboot -s "${FASTBOOT_DEVICE_SPECIFIER}" oem partapp "${RPI_DEVICE_STORAGE_TYPE}" 0c "$(stat -c%b*%B "${RPI_SB_WORKDIR}"/bootfs-temporary.simg)"
sleep 2
...
fastboot -s "${FASBOOT_DEVICE_SPECIFIER}" oem led PWR 0
