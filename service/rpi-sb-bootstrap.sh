...
if [ -n "${RPI_DEVICE_FETCH_METADATA}" ] && [ ! -f "/var/log/rpi-sb-provisioner/${TARGET_DEVICE_SERIAL}/special-skip-keywriter" ] && [ -d "/var/log/rpi-sb-provisioner/${TARGET_DEVICE_SERIAL}/metadata/" ]; then
